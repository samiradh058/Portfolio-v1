      ...
      >
        ...
        <div className="grid lg:grid-cols-[420px_1fr] gap-10 items-start">
          ...
          >
            ...
            {[
              {
                ...
                text:
                  "Over the last few years, I have specialized in frontend development with React and Next.js, creating scalable interfaces with a strong focus on performance, UX, and maintainability.",
              },
              {
                title: "Backend Expansion",
                text:
                  "Alongside frontend, I explored Node.js, Express, and NestJS, eventually diving deeper into FastAPI and PostgreSQL to strengthen backend architecture skills.",
              },
              {
                title: "Current Focus",
                text:
                  "Recently, I’ve been exploring Python, LLMs, web automation, and AI systems while continuing to improve my full-stack engineering depth.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <p className="text-dim leading-8">
                  {item.text}
                </p>
              </motion.div>
            ))}
            ...
            {/* tags */}
            <motion.div variants={fade} className="pt-6">
              <p className="text-xs uppercase tracking-[0.18em] text-dim mb-4">
                Currently Exploring
              </p>
